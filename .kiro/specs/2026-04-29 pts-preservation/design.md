...
| `app-metrics-two-tier` | 2026-06-15 | **No conflict.** Metrics collection keys (`MetricKey.EXTRACTION`, `MetricKey.MERGE`) are unchanged. The new `_extract_timestamps()` step may be timed under `MetricKey.EXTRACTION` if desired. |
