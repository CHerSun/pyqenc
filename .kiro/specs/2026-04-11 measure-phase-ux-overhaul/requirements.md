...
8. THE benchmarking script SHALL be retained at `.kiro/specs/2026-04-11 measure-phase-ux-overhaul/benchmark_screenshots.py` as research evidence.
9. THE benchmarking results SHALL be recorded in `.kiro/specs/2026-04-11 measure-phase-ux-overhaul/benchmark_results.md`.
