...
- [x] 5. Add `parse_metrics` to `pyqenc/utils/visualization.py`
...
- [x] 6. Add `normalize_metrics` to `pyqenc/utils/visualization.py`
...
- [x] 7. Add `compute_metric_stats` and make `extract_key_stats` public
...
- [x] 8. Refactor `create_unified_plot` to accept `pd.DataFrame`
...
- [x] 9. Refactor `analyze_chunk_quality` and `_finish_evaluation` to use new pipeline
...
- [x] 10. Checkpoint — run tests and fix failures
  - `uv run python -m pytest tests/`

- [x] 11. Cross-spec review and completion
