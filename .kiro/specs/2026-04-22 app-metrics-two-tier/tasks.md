# Implementation Plan: Two-Tier App Metrics System
...
- [x] 2. Replace `TimeKey` with `MetricKey` in `pyqenc/metrics.py`
  ...
  - [x] 2.3 Write property test for `_last_dot_prefix` (Property 1)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 1: Prefix extraction is last-dot`
...
- [x] 5. Update `YamlMetricsCollector` internals
  ...
  - [x] 5.5 Write property test for time accumulation (Property 2)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 2: Time accumulation is additive`
  ...
  - [x] 5.6 Write property test for top-level percentages (Property 3)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 3: Top-level percentages sum to 100%`
  ...
  - [x] 5.7 Write property test for dotted percentages (Property 4)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 4: Dotted percentages sum to 100% per prefix`
  ...
  - [x] 5.8 Write property test for top-level sort order (Property 8)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 8: Top-level list sorted descending with no zeros`
  ...
  - [x] 5.9 Write property test for dotted breakdown sort order (Property 9)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 9: Dotted breakdown sorted descending with no zeros`
...
- [x] 6. Update `_try_resume()` for two-tier YAML structure
  ...
  - [x] 6.1 Write property test for resume (Property 6)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 6: Resume restores accumulated store`
...
- [x] 8. Sanitize ASCII dots in `Strategy` and `BaseStrategy`
  ...
  - [x] 8.3 Write property test for strategy dot sanitization (Property 7)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 7: Strategy dot sanitization produces valid metric keys`
...
- [x] 10. Update `test_metrics_properties.py` for two-tier model
  ...
  - [x] 10.1 Write property test for YAML round-trip (Property 5)
    ...
    - Tag: `# Feature: app-metrics-two-tier, Property 5: YAML serialisation round-trip preserves all values`
...
- [ ] 13. Review spec against other specs and add cross-spec summary
  - Review `app-metrics-two-tier` against related specs (`app-metrics-report`,
