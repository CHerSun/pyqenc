# Implementation Plan: App Metrics Report
...
- [x] 3. Implement Pydantic data models in `pyqenc/metrics.py`
  ...
  - [x] 3.2 Write property test for YAML serialization round-trip (Property 6)
    ...
    - Tag: `# Feature: app-metrics-report, Property 6: YAML serialization round-trip`
...
- [x] 5. Implement `_measure_space` and `ConvergenceAccumulator` internals
  ...
  - [x] 5.3 Write property test for space measurement accuracy (Property 4)
    ...
    - Tag: `# Feature: app-metrics-report, Property 4: Space measurement accuracy`
  ...
  - [x] 5.4 Write property test for convergence stats math (Property 5)
    ...
    - Tag: `# Feature: app-metrics-report, Property 5: Convergence stats math`
...
- [x] 7. Implement `YamlMetricsCollector`
  ...
  - [x] 7.7 Write property test for time accumulation round-trip (Property 1)
    ...
    - Tag: `# Feature: app-metrics-report, Property 1: Time accumulation round-trip`
  ...
  - [x] 7.8 Write property test for time distribution math (Property 2)
    ...
    - Tag: `# Feature: app-metrics-report, Property 2: Time distribution math`
  ...
  - [x] 7.9 Write property test for breakdown sorted descending (Property 3)
    ...
    - Tag: `# Feature: app-metrics-report, Property 3: Breakdown sorted descending`
...
- [x] 21. Review spec against other specs and update cross-spec summaries
  - Compare `app-metrics-report` spec dates and content against other specs in `.kiro/specs/`
